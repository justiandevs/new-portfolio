      ...
      <main className="relative">
        <div className="absolute z-10 top-0 left-0 bottom-0 right-0">
          <div className="custom-container h-full flex justify-between">
            <div className="h-full border-opacity-50 border-r border-zinc-200 ml-10 md:ml-20"></div>
            <div className="h-full border-opacity-50 border-r border-zinc-200"></div>
            <div className="h-full border-opacity-50 border-r border-zinc-200 mr-10 md:mr-20"></div>
          </div>
        </div>
        <div className="relative z-30">
          <nav className="custom-container py-12 flex justify-between flex-row items-center">
            ...
            <a href={"#contact"} className="opacity-100 bg-lime-500 py-4 px-4 py-3 rounded-lg text-black font-medium transition duration-300 hover:bg-lime-500">
              Contact
            </a>
          </nav>
          <section className="py-32 custom-container">
            <div className="flex flex-col gap-8 w-full lg:w-1/2">
              <h1>I am a <span className="text-lime-500">creative developer</span> who build things that you will like 🤗</h1>
              ...
              <a href={"#about"} className="group text-lime-500 font-semibold opacity-100 flex flex-row gap-4 items-center transition duration-300 hover:text-lime-600">
                Learn more about me
          ...
          <section id="about" className="custom-container py-32 grid grid-cols-1 md:grid-cols-3 gap-16">
            <div className="col-span-1 md:col-span-2 flex gap-8 flex-col">
              <h2>Who <span className="text-lime-500">am I</span></h2>
              ...
              <p>Since a few years I program a lot and currently I am a second years Computer Science student, next to this section you can see the technologies I am well-known with and at my <a className="opacity-100 text-lime-400 font-semibold transition duration-300 hover:text-lime-600" href="https://github.com/justiandevs">github</a> you can see my opensource projects / contributions and under this section you can see my work.</p>
              <a href={"#work"} className="group text-lime-500 font-semibold opacity-100 flex flex-row gap-4 items-center transition duration-300 hover:text-lime-600">
                My work
                <FaArrowRight className="transition duration-300 group-hover:translate-x-1 group-hover:rotate-45" />
              </a>
            </div>
            <div className="col-span-1 md:col-span-1 flex flex-col gap-8 md:items-end">
              ...
              <div className="flex flex-wrap md:grid md:grid-cols-3 gap-4">
                <Link href="https://figma.com" className="bg-white opacity-100 border flex items-center justify-center border-zinc-200 border-opacity-50 rounded-lg w-12 h-12">
                  <Image height={16} width={16} src={figma} alt={"figma"} />
                </Link>
                <Link href="https://nestjs.com" className="bg-white opacity-100 border flex items-center justify-center border-zinc-200 border-opacity-50 rounded-lg w-12 h-12">
                  <Image height={16} width={16} src={nest} alt={"nestjs"} />
                </Link>
                <Link href={"https://postgresql.com"} className="bg-white opacity-100 border flex items-center justify-center border-zinc-200 border-opacity-50 rounded-lg w-12 h-12">
                  <Image height={16} width={16} src={postgresql} alt={"postgresql"} />
                </Link>
                <Link href={"https://reactjs.org"} className="bg-white opacity-100 border flex items-center justify-center border-zinc-200 border-opacity-50 rounded-lg w-12 h-12">
                  <Image height={16} width={16} src={react} alt={"react"} />
                </Link>
                <Link href={"https://supabase.com"} className="bg-white opacity-100 border flex items-center justify-center border-zinc-200 border-opacity-50 opacity-100 rounded-lg w-12 h-12">
                  <Image height={16} width={16} src={supabase} alt={"supabase"} />
                </Link>
                <Link href={"https://tailwindcss.com"} className="bg-white opacity-100 border flex items-center justify-center border-zinc-200 border-opacity-50 rounded-lg w-12 h-12">
                  <Image height={16} width={16} src={tailwind} alt={"tailwind"} />
                </Link>
              </div>
            </div>
          </section>
          <section id="work" className="py-16 bg-white border-t border-b border-zinc-200 border-opacity-50" style={{borderRadius: "64px"}}>
            <div className="custom-container flex flex-col gap-8 items-center">
              <h2>My <span className="text-lime-500">work</span></h2>
              <div className="grid grid-cols-1 md:grid-cols-3 w-full gap-8">
                <Link href="https://tiktok.mrboost.nl" className="col-span-1 bg-lime-500 border border-lime-400 border-opacity-40 opacity-100 rounded-lg transition duration-300 hover:bg-lime-600">
                  <Image src={"/assets/mockup-tiktok.png"} alt={"tiktok agency website for mrboost"} width={1000} height={1000} />
                  <h3 className="px-8 pb-8 -mt-16 text-white">TikTok Agency site for MrBoost</h3>
                </Link>
                <div className="col-span-1 md:col-span-2 border border-lime-400 border-opacity-40 border-dashed rounded-lg p-8 flex flex-col justify-center gap-4">
                  ...
                  <a href={"#contact"} className="group text-lime-500 font-semibold opacity-100 flex flex-row gap-4 items-center transition duration-300 hover:text-lime-600">
                    Lets drink a coffee
                    <FaArrowRight className="transition duration-300 group-hover:translate-x-1 group-hover:rotate-45" />
                  </a>
                </div>
          ...
          <section id="contact" className="custom-container py-32 flex flex-col gap-8">
            <h2>Lets <span className="text-lime-500">get in <br />touch</span></h2>
            ...
            <p>Send a mail to <a href="mailto:mail@justian.dev" className="font-semibold opacity-100 text-lime-500 transition duration-300 hover:text-lime-600">mail@justian.dev</a></p>
          </section>
          <footer className="custom-container flex pb-32 flex-col md:flex-row gap-4 justify-between">
            ...
            <div className="flex flex-row gap-2">
              <a href={"https://github.com/justiandevs"} aria-label="github" className="opacity-100">
                <div className="p-3 border border-zinc-200 bg-white border-opacity-50 rounded-full transition duration-300 hover:border-opacity-500">
                  <FaGithub />
                </div>
              </a>
